...
const projects = [
  {
    ...
    roles: [
      ...
      'Toss API를 사용한 결제 기능 - Toss Payments API 문서를 참고하여 결제 요청과 요청에 대한 에러 처리, 결제 승인과 에러 처리 작업을 수행',
      'Session을 통한 장바구니 기능 - 사용자가 전시회 상품에 대해 session을 통해 장바구니를 사용할 수 있도록 구현',
